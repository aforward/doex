defmodule Doex.ClientTest do
  ...
  test "droplet_ip none" do
    %{
      ...
      "networks" => %{
        "v4" => [
          %{
            "gateway" => "10.137.0.1",
            "ip_address" => "99.98.97.96",
            "netmask" => "255.255.0.0",
            "type" => "private"
          },
          %{
            "gateway" => "138.197.160.1",
            "ip_address" => "199.198.197.196",
        ...
        "v6" => [
          %{
            "gateway" => "9999:A880:0CAD:00D0:0000:0000:0000:0001",
            "ip_address" => "9999:A880:0CAD:00D0:0000:0000:362A:8001",
            "netmask" => 64,
            "type" => "public"
          }
        ]
    ...
    assert nil ==
             Client.droplet_ip(%{
               "networks" => %{"v6" => [%{"type" => "public", "ip_address" => "9999"}]}
             })
  end
